...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?= BASE_URL?>public/img/ico.ico">
  ...
  <div class="flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav class="md:ml-auto flex flex-wrap items-center text-base">
      ...
      if(!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] !== true){
        ...
        ?>
        <a class="mr-5 hover:text-gray-900" href="<?= BASE_URL?>views/logout.php">Logout</a>
        <?php
      }
      ?>
    </nav>
